    ...
    <div class="container-fluid">
        <div class="row" style = "height:8vh;">
            <div class="col m-0 p-0 d-block d-xl-none logo-h">
                <a href="studentpage/Sidebar/profile.php" class="logo-h" target="mainpage"> <h1 class="logo logo-h d-inline"> CETA </h1> </a>
            ...
            <div class="col m-0 p-0 d-none d-xl-block logo-h" >
                ...
                <a href="studentpage/Sidebar/profile.php" target="mainpage" class="logo-h"> <h1 class="logo logo-h d-inline" style="font-size:6vh;"> CETA </h1> </a>
        ...
        <div class="row">
            <div class="col p-0 m-0">
                <div class="collapse navbar-collapse p-0 m-0" id="sidebarmenu">
                        ...
                        <?php require("studentpage/sidebar.php")?>
                </div>    
            </div>
        </div>
        ...
        <div class="row" style="height:100vh;">
            <div class="col p-0 m-0">
                <iframe src="studentpage/mainpage.php" name="mainpage" style="border-style:none;width:100%;height:100%;" ></iframe>
