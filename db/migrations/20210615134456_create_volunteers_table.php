...
class CreateVolunteersTable extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $table = $this->table('volunteers',['id' => false]);
        $table->addColumn('fname', 'string', ['limit' => 20, 'null' => false])
            ...
            ->addColumn('branch', 'string', ['limit' => 10, 'null' => false])
    ...
    {
        $this->table('volunteers')->drop()->save();
    }
}
