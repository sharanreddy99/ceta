...
<!-- Sidebar on small screens when clicking the menu icon -->
	...
	<img  vspace=60px class="w3-image w3-bar w3-display-container " src="http://www.mirci.org/wp-content/uploads/upcomingevents.jpg" >
	...
	// Close the sidebar with the close button
		...
		<object style="width:100%;height:100%;overflow:scroll;" data="upcomingevents.php">
		</object>
